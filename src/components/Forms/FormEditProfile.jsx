...
const FormEditProfile = ({ closeModal }) => {
  ...
  useEffect(() => {
    currentUser.image
      ...
      ? setImageProfile(`https://res.cloudinary.com/dtr9a2dsx/image/upload/v1670273532/alphabet/${currentUser.name.toLowerCase().slice(0, 1)}.png`)
      : setImageProfile(`https://res.cloudinary.com/dtr9a2dsx/image/upload/v1670273532/alphabet/x.png`);
  }, []);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="sameLine">
            ...
            <div className="right">
              ...
              <input onChange={handleChange} value={new Date(values.birth).toISOString().split("T")[0]} type="date" id="birth" name="birth" max={current} />
            </div>
          </div>
