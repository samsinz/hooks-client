    ...
    <div className="part2">
      ...
      <div className="sameLine">
        <div className="left">
          ...
          <input onChange={handleChange} value={values.location} type="text" id="location" name="location" />
        </div>
        <div className="right">
          <label htmlFor="date">When</label>
          <input onChange={handleChange} value={values.date} max={current} min={minimumDate} type="date" id="date" name="date" />
        </div>
      </div>
      ...
      <div className="newHookDuration">
        ...
        <input onChange={handleChange} value={values.duration} min="0" max="2" type="range" id="duration" name="duration" />
